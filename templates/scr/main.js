    ...
    const questions = [
        { id: "primeiro_nome", text: "Olá! 👋 Para começar, qual é o seu primeiro nome?", type: "text", required: true },
        { id: "sobrenome", text: "Ótimo! E qual é o seu sobrenome?", type: "text", required: true },
        { id: "titulo", text: "Qual o título da reportagem?", type: "text", required: true },
        { id: "descricao", text: "Descreva a reportagem:", type: "textarea", required: true },
        { 
            id: "categoria", 
            text: "Em qual categoria a reportagem se encaixa?", 
            type: "select", 
            required: true,
            options: [
                { value: "politica", text: "🏛️ Política" },
        ...
        { id: "img_path", text: "Envie uma imagem de capa (opcional):", type: "file", required: false },
