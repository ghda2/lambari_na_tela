...
function showSummary() {
    ...
    summaryMessage.innerHTML = `
        ...
        <p><strong>Nome do Pet:</strong> ${document.getElementById("nome_pet").value}</p>
        <p><strong>Tipo:</strong> ${document.getElementById("tipo_pet").value}</p>
        <p><strong>Raça:</strong> ${document.getElementById("raca").value}</p>
        ...
        <p><strong>Foto:</strong> ${uploadedImagePath.name}</p>
    `;
    ...
    confirmButton.textContent = "Enviar Anúncio";
